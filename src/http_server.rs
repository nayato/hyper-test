...
impl Service for HttpServer {
    ...
    fn call(&self, req: Request) -> Self::Future {
        match (req.method(), req.path()) {
            ...
            //         .boxed(),
            // ),
            _ => future::ok(Response::new().with_status(NotFound)),
        }
    }
}
